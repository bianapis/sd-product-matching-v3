...
/**
 * BQContextCriteriaInitiateOutputModel
 */
public class BQContextCriteriaInitiateOutputModel   {
  private String contextCriteriaInstanceReference = null;

  private String contextCriteriaInitiateActionReference = null;

  private Object contextCriteriaInitiateActionRecord = null;

  private String contextCriteriaInstanceStatus = null;
  ...
  **/
   ...
   * @return contextCriteriaInitiateActionReference
  **/

  public String getContextCriteriaInitiateActionReference() {
    return contextCriteriaInitiateActionReference;
  }

  public void setContextCriteriaInitiateActionReference(String contextCriteriaInitiateActionReference) {
    this.contextCriteriaInitiateActionReference = contextCriteriaInitiateActionReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Context Criteria instance (e.g. initialised, pending, active) 
   * @return contextCriteriaInstanceStatus
  **/

  public String getContextCriteriaInstanceStatus() {
    return contextCriteriaInstanceStatus;
  }

  public void setContextCriteriaInstanceStatus(String contextCriteriaInstanceStatus) {
    this.contextCriteriaInstanceStatus = contextCriteriaInstanceStatus;
  }
